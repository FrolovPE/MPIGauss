...
void mat_mult_sub_optimized(double *A, double *B, double *C, 
    int m_size, int n_cols, int k_common, 
...
int MPI_Solve(double *a, double *b, double *x,int n,int m,int p,int kk,double *buf,double *tmpbuf,double *vecbuf,double *resvec,double *block_mm, double *block_ml, double *block_ll,double *invblock_mm, double *diaginvblock_mm, 
    double *invblock_ll,double *diagblock_mm,
    int *colsw,double *vecb_m,double *vecb_l,
